...
<div class="form-group">
  <label for="page_content2_subtitle">Content 2 Subtitle</label>
  <input value="<?php echo $page_content2_subtitle; ?>" type="text" class="form-control" name="page_content2_subtitle">
</div>
...
<div class="form-group">
  <label for="page_CTA_subtitle">CTA Subtitle</label>
  <input value="<?php echo $page_CTA_subtitle; ?>" type="text" class="form-control" name="page_CTA_subtitle">
</div>
...
<div class="form-group">
  ...
  <textarea class="form-control" name="page_CTA2_content" id="content5" cols="30" rows="10"><?php echo $page_CTA2_content; ?></textarea>
</div> -->
