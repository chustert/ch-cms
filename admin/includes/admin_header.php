...
<head>
    ...
    while($row = mysqli_fetch_assoc($select_settings_query)) {
        ...
        <title><?php echo $title ?> - Hotera CMS</title>
...
<script src="https://cdn.tiny.cloud/1/7t49ntgel8z2g1f5iw8zz0qswtnibttenn2swhli1txyy1cd/tinymce/5/tinymce.min.js" referrerpolicy="origin"></script>
